    ...
    <Card className={classes.card}>
      <CardContent>
        ...
        <TextField
          ...
          margin="normal"
        /><br />
        <TextField id="startingBid" label="Starting Bid (Rs.)" className={classes.textField} value={auction.startingBid} onChange={handleChange('startingBid')} margin="normal" /><br />
        <br />
        <TextField
          id="datetime-local"
