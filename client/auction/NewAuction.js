    ...
    <Card className={classes.card}>
      <CardContent>
        ...
        <TextField
          ...
          margin="normal"
        /><br />
        <TextField id="startingBid" label="Starting Bid (Rs.)" className={classes.textField} value={values.startingBid} onChange={handleChange('startingBid')} margin="normal" /><br />
        <br />
        <TextField
          id="datetime-local"
